<br>
<label for="quicksearch"></label><input type="radio" id="quicksearch" value="<?php echo $curr_product_id_ver ?>" name="<?php echo $productGroup ?>" checked>New&nbsp;Book&nbsp;of&nbsp;Knowledge&nbsp;Only</p>
