...
$i=0;
$servers = array();
$servers[$i]['name'] = 'gicauthm.grolier.com';    /*  A convenient name that will appear in 
                                                the tree viewer and throughout phpLDAPadmin to 
                                                identify this LDAP server to users. */
$servers[$i]['host'] = 'gicauthm.grolier.com';  /*  Examples: 
                                                   'ldap.example.com', 
                                                ...
                                                ignore this server. */
$servers[$i]['base'] = 'dc=grolier,dc=com'; /*  The base DN of your LDAP server. Leave this 
...
$servers[$i]['login_dn'] = 'cn=Manager,dc=grolier,dc=com';
...
$servers[$i]['login_attr'] = 'session';          /*  If you specified 'cookie' or 'session' as the auth_type above, 
...
$i++;
$servers[$i]['name'] = 'gicauths1.grolier.com';
$servers[$i]['host'] = 'gicauths1.grolier.com';
$servers[$i]['base'] = 'dc=grolier,dc=com';
$servers[$i]['port'] = 389;
...
$i++;
$servers[$i]['name'] = 'gicauths2.grolier.com';
$servers[$i]['host'] = 'gicauths2.grolier.com';
$servers[$i]['base'] = 'dc=grolier,dc=com';
$servers[$i]['port'] = 389;
$servers[$i]['auth_type'] = 'config';
$servers[$i]['login_dn'] = 'cn=Manager,dc=grolier,dc=com';
