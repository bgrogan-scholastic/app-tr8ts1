...
// +----------------------------------------------------------------------+
//
// $Id: Client.php,v 1.62 2003/08/06 20:08:45 arnaud Exp $
//
 ...
 *
 * @access   public
 * @version  $Id: Client.php,v 1.62 2003/08/06 20:08:45 arnaud Exp $
 * @package  SOAP::Client
...
class SOAP_Client extends SOAP_Base
{
     ...
     * @var array
     */
    var $__options = array('trace'=>0, 'result'=>'parse');
    ...
    */
	...
	# 9/24/2003: R.E. Dye
	# Added to allow XML parsing to be turned on and off
	function setXMLparse($newparse)
	{
		$oldparse = $this->__options['result'];
		$this->__options['result']=$newparse;
		return $oldparse;
	}
