...
// to fix a problem in IE on the Mac    DKF
  this.newWindow = function(inContentURL, inWidth, inHeight, inWindowName, inResize, inMenubar, inStatusbars, inScrollbars, inToolbar, inLocationbar) {
    ...
    this._newBrowserWindow(inContentURL, inWidth, inHeight, inWindowName, 
                           ...
                           inToolbar, inLocationbar);
    this._setFocus();
  }
                

  // Private function for creating a new window
  this._newBrowserWindow = function(inContentURL, inWidth, inHeight, inWindowName, inResize, inStatusbars, inScrollbars, inMenubar, inToolbar, inLocationbar) {
