...
__author__ = "Todd A. Reisel, modifications by Tyrone Mitchell, Chuck Prahm 3/15/05"
...
class GI_Transform_NewsTemplate(GI_Transform):
	...
	def _process(self):
		...
		#this block is pretty nbps2 specific
		templateType = "inactive";
		if (self._params['status'] != 'inactive') :
			templateType = "/newsbytes/newsbytes_"+self._params['type']+self._params['status']+".html";
		#this block ends nbps2 specific stuff
