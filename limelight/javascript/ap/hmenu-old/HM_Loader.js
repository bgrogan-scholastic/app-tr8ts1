...
HM_GL_MenuWidth          = 100;			//was 150
HM_GL_FontFamily         = "Verdana,sans-serif";
HM_GL_FontSize           = 11;
HM_GL_FontBold           = false;		//was true
...
if(HM_IsMenu) {
	document.write("<SCR" + "IPT LANGUAGE='JavaScript1.2' SRC='/javascript/hmenu/HM_Arrays.js' TYPE='text/javascript'><\/SCR" + "IPT>");
	document.write("<SCR" + "IPT LANGUAGE='JavaScript1.2' SRC='/javascript/hmenu/HM_Script"+ HM_BrowserString +".js' TYPE='text/javascript'><\/SCR" + "IPT>");
}
