...
(function($){  
	...
	*/
	...
	{	
		...
		popupObj.css("z-index", topZIndex);

        //  Nabeel - bug fix for the content div in there
        //var content_z_index = topZIndex + 10;
        //var elem = $(popupObj).find('.' + options.contentClass);
        //elem.css({zIndex: content_z_index});
	...
	return this.each(function() {
		...
		if(options.contentLoadPath)
		{
			...
			elem.load(options.contentLoadPath, function()
                {
                   options.postLoad(popupObj);
                });
		}
